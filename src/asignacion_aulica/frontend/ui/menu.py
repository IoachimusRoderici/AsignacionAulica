...
class UI_Menu:
    def __init__(self):
        self.icono_UNRN = UI_UNRN("./ui/imgs/UNRN_Andina.png")
        self.boton_menu = UI_MenuBoton("./ui/imgs/icono_menu.png", "Menú")
        self.boton_nuevo = UI_MenuBoton("./ui/imgs/icono_nuevo.png", "Nuevo")
        self.boton_abrir = UI_MenuBoton("./ui/imgs/icono_abrir.png", "Abrir")
        self.boton_guardar = UI_MenuBoton("./ui/imgs/icono_guardar.png", "Guardar")
        self.boton_importar = UI_MenuBoton("./ui/imgs/icono_importar.png", "Importar")
        self.boton_exportar = UI_MenuBoton("./ui/imgs/icono_exportar.png", "Exportar")
